...
public class Store2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Perawatan Hewan");
    ...
    private void setProduct() {
        ...
        simpleAdapter = new SimpleAdapter(this, arrayList, R.layout.adapter_store2,
        ...
        grdProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(net.hafiznaufalr.petsin.store.store2.Store2.this, Detail2.class));
            }
        });
    }
