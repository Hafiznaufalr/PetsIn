...
import net.hafiznaufalr.petsin.store.store5.Detail5;
...
public class Store6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Obat & Vitamin");
    ...
    private void setProduct() {
        ...
        grdProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(net.hafiznaufalr.petsin.store.store6.Store6.this, Detail6.class));
            }
        });
    }
