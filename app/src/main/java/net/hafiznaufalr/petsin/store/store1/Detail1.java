...
public class Detail1 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    private void checkout() {
        dialog = new Dialog(Detail1.this);
        ...
        btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(Detail1.this, Cart.class));
                finish();
            }
        });
