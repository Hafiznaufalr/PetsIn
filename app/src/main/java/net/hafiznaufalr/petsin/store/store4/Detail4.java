...
public class Detail4 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    private void checkout() {
        dialog = new Dialog(net.hafiznaufalr.petsin.store.store4.Detail4.this);
        ...
        btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(net.hafiznaufalr.petsin.store.store4.Detail4.this, Cart.class));
                finish();
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("Keranjang",R.drawable.produk4);
        file_maps.put("Keranjang",R.drawable.produk4);
        file_maps.put("Keranjang",R.drawable.produk4);
        file_maps.put("Keranjang", R.drawable.produk4);
