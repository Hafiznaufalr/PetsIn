package net.hafiznaufalr.petsin.store.store6;
...
public class Detail6 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    private void checkout() {
        dialog = new Dialog(net.hafiznaufalr.petsin.store.store6.Detail6.this);
        ...
        btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(net.hafiznaufalr.petsin.store.store6.Detail6.this, Cart.class));
                finish();
            }
        });
